...
public class SendEamil {
    private String msg = "尊贵的用户您好：\n" +
            "您的验证码是：";
    private String msg1 = "收到验证邮件后，请及时验证哦。";
    //
    private String nqq = "111111@qq.com";
    private String pwd = "hfimlvlcsdjsbeci1";
    ...
    public void sendToken(String to1, String token) throws MessagingException, GeneralSecurityException {
        ...
        Session session = Session.getDefaultInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(nqq, pwd);
            }
        });
        ...
        //连接服务器
        transport.connect("smtp.qq.com", nqq, pwd);

        //创建邮件对象
        MimeMessage mimeMessage = new MimeMessage(session);

        //邮件发送人
        mimeMessage.setFrom(new InternetAddress(nqq));
