package com.testdemo.controller.user;

import com.testdemo.base.BaseController;
import com.testdemo.common.ResponseCode;
...
import com.testdemo.service.user.SystemUserService;
...
//import com.testdemo.core.TokenLimit;

/**
 * 系统用户
 */
@Api(value = "sys_user1", description = "系统用户", tags = "系统用户")
@Controller
...
public class SystemUserController extends BaseController {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(paramType="query", name = "jurisdiction_manage_id", value = "角色", required = false, dataType = "String"),
